...
datasets = {
    ...
    "source_post_media": [{"source_post_media_id": "m", "source_post_id": "sp", "canonical_post_url": "https://www.youtube.com/watch?v=8Xmkojfw90Q", "original_media_url": "https://origin.example/video.mp4", "media_index": "0"}],
    "media_assets": [{"media_id": "m", "source_post_id": "sp", "storage_url": "https://res.cloudinary.com/demo/video/upload/x.mp4"}],
}
candidates = [{"account_id": "night_scout", "canary_type": "direct_video", "source_post_id": "sp", "media_asset_id": "m", "media_url": "https://res.cloudinary.com/demo/video/upload/x.mp4"}]
