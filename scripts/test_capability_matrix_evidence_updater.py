...
status={"accounts": {account: {kind: {"state":"UNVERIFIED", "evidence":{}} for kind in ("original_text","reference_text","direct_image","direct_video","direct_carousel","generated_clip","scheduled_publish","result_persistence","metrics","pdca","persona")} for account in ("night_scout","liver_manager")}}
