...
rows = [*manifest["x_exact_statuses"], *manifest["youtube_goldens"], *manifest["tiktok_goldens"]]
checks = {
    ...
    "one owner-authorized TikTok golden": len(manifest["tiktok_goldens"]) == 1 and manifest["tiktok_goldens"][0]["source_id"] == "src_lm_tt_user_001",
