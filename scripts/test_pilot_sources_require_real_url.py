...
urls = [row["source_url"] for rows in plan["selected"].values() for row in rows]
checks = [
    ("all have urls", all(urls)),
    ("no TODO urls", not any("TODO" in url or "example.com" in url for url in urls)),
]
