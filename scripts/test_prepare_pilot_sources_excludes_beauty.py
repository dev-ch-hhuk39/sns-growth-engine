...
accounts = {row["target_account_id"] for rows in plan["selected"].values() for row in rows}
checks = [("beauty excluded", "beauty_account" not in accounts), ("safety beauty false", plan["safety"]["beauty_account"] is False)]
