...
args=argparse.Namespace(input_path="a.mp4", rights_status="owned", dry_run=True, cut=False, confirm_cut=False, vertical=False, burn_subtitles=False)
p=c.build_plan(args)
checks=[("owned accepted plan", p["status"]=="PLAN_ONLY"), ("no cut dry", p["ffmpeg_cut"] is False)]
