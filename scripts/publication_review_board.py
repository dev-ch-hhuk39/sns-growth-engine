...
def review_row(queue: Mapping[str, Any], existing: Mapping[str, Any] | None = None) -> dict[str, str]:
    ...
    return {
        ...
        "provider_error_type": text(queue.get("provider_error_type")),
        "provider_http_status": text(queue.get("provider_http_status")),
        "provider_mode": text(queue.get("provider_mode")),
        "fallback_mode": text(queue.get("fallback_mode")),
        "fallback_reason": text(queue.get("fallback_reason")),
