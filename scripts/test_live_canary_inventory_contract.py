...
datasets["queue"]=[
    {"account_id":"night_scout","canary_id":"canary_fresh_night_scout_original_text_x","status":"READY","generation_mode":"original_text","public_post_text":"読者が役立つ自然な投稿です。","validator_status":"PASS","account_fit_status":"PASS"},
    {"account_id":"night_scout","canary_id":"canary_fresh_night_scout_generated_clip_x","status":"WAITING_REVIEW","media_type":"generated_clip","clip_candidate_id":"clip_system_owned_night_scout_run_generated_clip","public_post_text":"読者が役立つ自然な投稿です。"},
]
