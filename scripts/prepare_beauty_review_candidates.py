...
SAFE_TOPIC_FALLBACKS = {
    ...
    TOPICS[6]: "アイメイクって、気になる色を全部足すと\nどこを見せたいのか迷うことない？🥺\n\n個人的には、主役を一つ決めてから\nほかの色を選ぶのが結構大事な気がする💭\n\n明日使いたいコスメを並べて\nアイメイクの主役にする色を一つ決めてみてほしい🤍",
    TOPICS[7]: "朝のメイクって、コスメを探す時間が\n思ってるより長くなりがちだよね🥺\n\n個人的には、使う順番が決まってるだけで\n次に何を手に取るか迷いにくい気がする💭\n\n今夜、明日使うコスメだけ選んで\nメイクする順番に並べてみてほしい🤍",
}
...
具体行動の文には「確認する・比べる・見直す・待つ・変える・メモする・並べる」のどれか1つを自然に使う。結果を保証するのではなく、読者が自分で試して判断できる書き方にする。
